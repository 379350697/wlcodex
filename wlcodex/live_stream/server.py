...
from wlcodex.live_stream.relay_work_log_projection import (
    RelayWorkLogProjectionDependencies,
...
def _marvis_relay_work_log_segments(
    ...
    *,
    ...
    return build_relay_work_log_segments(
        detail,
        hub=hub,
        canonical_payloads=canonical_payloads,
        deps=_RELAY_WORK_LOG_PROJECTION_DEPENDENCIES,
    )
...
_RELAY_WORK_LOG_PROJECTION_DEPENDENCIES = RelayWorkLogProjectionDependencies(
    role_ids=frozenset(RELAY_ROLE_IDS),
    ...
    worker_events=_relay_worker_events_for_roles,
    native_message_key=_relay_native_message_key,
    native_event_text=_relay_native_event_text,
    text_is_protocol_noise=_marvis_relay_work_log_text_is_protocol_noise,
    public_role=_marvis_relay_public_role,
    segment_factory=WorkLogSegment,
    entry_factory=WorkLogEntry,
    merge_entry=_marvis_relay_merge_work_log_entry,
    entry_from_event=_marvis_relay_work_log_entry_from_event,
    humanize_role_envelope=_relay_humanize_role_envelope,
    action_label=_marvis_relay_action_label,
    role_status_label=_marvis_relay_role_status_label,
    confirmation_source_label=_marvis_relay_confirmation_source_label,
    finalize_segments=_marvis_relay_finalize_work_log_segments,
    payload_status_is_success=_relay_payload_status_is_success,
    role_label=_relay_role_label,
    humanize_display_text=_relay_humanize_display_text,
)
